...
mydict = {}
dict_rights = {'write': 'W', 'read': 'R','execute': 'X'}

for _ in range(int(input())):
    adres, *rights = input().split()
    mydict.setdefault(adres, rights)

for _ in range(int(input())):
    right_z, adres_z = input().split()
    print('OK' if dict_rights[right_z] in mydict[adres_z] else 'Access denied')
