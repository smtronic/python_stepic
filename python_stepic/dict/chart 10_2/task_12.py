...
#list_names = [user['name'] for user in users if user['phone'].endswith('8')]
#print(*sorted(list_names))
email_none = [user['name'] for user in users if 'email' not in user.keys() or user['email'] == '']
print(*sorted(email_none))
