...
# информацию о которых Тимур сохранил в телефонной книге. В следующих nn строках заданы
# телефоны и имена их владельцев через пробел. В следующей
# строке записано целое число mm — количество поисковых запросов от Тимура.
# В следующих mm строках записаны сами запросы, по одному на строке.
...
for _ in range(int(input())):
    ...
    my_dict.setdefault(name, []).append(number)
for _ in range(int(input())):
    print(*my_dict.get(input().upper(),['абонент не найден']))
